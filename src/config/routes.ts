...
router.get('/api/users/:id/track', userController.getTrack)
router.get('/api/users/:id/track/:event', userController.getTrackOfEvent)
router.put('/api/users/:id/track/:event', userController.updateTrack)
